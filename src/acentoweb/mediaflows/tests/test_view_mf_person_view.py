...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_mf_person_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='mf-person-view'
        )
        self.assertTrue(view.__name__ == 'mf-person-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in mf-person-view'
        # )

    def test_mf_person_view_not_matching_interface(self):
