...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_mf_activity_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='mf-activity-view'
        )
        self.assertTrue(view.__name__ == 'mf-activity-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in mf-activity-view'
        # )

    def test_mf_activity_view_not_matching_interface(self):
