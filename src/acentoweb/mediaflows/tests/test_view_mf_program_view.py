...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_mf_program_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='mf_program'
        )
        self.assertTrue(view.__name__ == 'mf_program')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in mf_program'
        # )

    def test_mf_program_not_matching_interface(self):
