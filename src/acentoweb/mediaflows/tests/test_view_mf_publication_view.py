...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_mf_publication_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='mf-publication-view'
        )
        self.assertTrue(view.__name__ == 'mf-publication-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in mf-publication-view'
        # )

    def test_mf_publication_view_not_matching_interface(self):
